...
CREATE INDEX idx_knowledge_base_entries_user_id ON public.knowledge_base_entries(user_id);
CREATE INDEX idx_knowledge_base_entries_agent_id ON public.knowledge_base_entries(agent_id);
CREATE INDEX idx_knowledge_base_entries_source_type ON public.knowledge_base_entries(source_type);